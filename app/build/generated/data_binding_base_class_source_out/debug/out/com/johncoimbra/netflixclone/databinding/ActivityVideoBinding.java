...
public final class ActivityVideoBinding implements ViewBinding {
  ...
  private ActivityVideoBinding(@NonNull ConstraintLayout rootView, @NonNull VideoView video) {
  ...
  public static ActivityVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.video;
      VideoView video = rootView.findViewById(id);
      if (video == null) {
        break missingId;
      }

      return new ActivityVideoBinding((ConstraintLayout) rootView, video);
    }
